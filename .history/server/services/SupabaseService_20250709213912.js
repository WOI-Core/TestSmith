...
class SupabaseService {
    ...
    async getProblemById(problemId) {
        ...
        if (downloadError) {
            console.error(`Failed to download config for ${problemId}:`, downloadError);
            // This will result in a 404 if the config doesn't exist
            return null; 
        }
        ...
        try {
            ...
            console.error(`Invalid config.json for ${problemId}:`, e);
