...
class ProblemController {
    ...
    static async createProblem(req, res, next) {
        try {
            ...
            if (newProblem && newProblem.problem_id) {
                const problemFileName = problemData.name; // Use the submitted name as the file name prefix
                
                await supabaseService.uploadProblemFiles(
                    newProblem.problem_id,
                    `${problemFileName}.md`, // Filename for markdown
                    problemData.statement,
                    `${problemFileName}.cpp`, // Filename for solution (assuming .cpp as per screenshot)
    ...
    static async getProblemDetailsFromStorage(req, res, next) {
        try {
            ...
            // Use problemNameFromConfig to construct the specific filenames
