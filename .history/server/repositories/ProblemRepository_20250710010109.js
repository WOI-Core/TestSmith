...
class ProblemRepository extends BaseRepository {
    ...
    async getAll() {
        const { data, error } = await this.supabase
            .from(this.tableName)
            .select('problem_id, problem_name, markdown_content, solution_code, difficulty, is_tagged, tags, embedding_vector')
    ...
    async findUntagged() {
        const { data, error } = await this.supabase
            .from(this.tableName)
            .select('problem_id, problem_name, markdown_content, solution_code, difficulty, is_tagged, tags, embedding_vector') // Changed 'id' to 'problem_id'
            .eq('is_tagged', false);
