      ...
      <Card>
        ...
        <CardContent>
          <form onSubmit={handleGenerate} className="flex flex-col gap-4 p-4 bg-card-bg rounded-lg">
            ...
            {status && <p className="mt-2 text-center p-2 bg-input-bg rounded">{status}</p>}
          </form>
        </CardContent>
      </Card>
              ...
              {isLoadingUntagged ? (
                ...
                untaggedProblems.map((problem) => (
                  <TableRow key={problem.id}>
                    ...
                    <TableCell>
                      <Button variant="ghost" size="sm" onClick={() => handleTag(problem)}>
                ...
                <TableRow>
                  <TableCell colSpan={4} className="text-center">No problems found in storage.</TableCell>
                </TableRow>
              )}
            </TableBody>
          </Table>
